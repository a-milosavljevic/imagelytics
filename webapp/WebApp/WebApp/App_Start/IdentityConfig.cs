...
namespace WebApp
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            client.EnableSsl = (ConfigurationManager.AppSettings["smtpUseSSL"] == "true");
            ...
            mailMessage.From = new MailAddress(ConfigurationManager.AppSettings["smtpFromAddress"], ConfigurationManager.AppSettings["smtpFromName"]);
