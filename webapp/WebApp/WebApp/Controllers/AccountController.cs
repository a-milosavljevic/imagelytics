    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (user != null)
            {
                ...
                {
                    var modelResend = new ResendConfirmationEmailViewModel() { Email = model.Email };
                    return View("ResendConfirmationEmail", modelResend);
                }
            }
        ...
        private async Task<bool> SendEmailConfirmationTokenAsync(string email)
        {
        ...
        public async Task<ActionResult> ResendConfirmationEmail(ResendConfirmationEmailViewModel model)
        {
            ...
            if (await SendEmailConfirmationTokenAsync(model.Email))
            {
                return View("ResendConfirmationEmailConfirmation");
            }
            else
